<x-admin-layout title="Edit a brand">
                ...
                <form class="form-new-product form-style-1" action="{{route('admin.brand.update')}}" method="POST"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Brand name" name="name"
                            id="brandName" tabindex="0" value="{{$brand->name}}" aria-required="true" required="">
                    </fieldset>
                    @error('name') <span class="alert alert-danger text-center">{{$message}}</span>@enderror
                    <fieldset class="name">
                        <div class="body-title">Brand Slug <span class="tf-color-1">*</span></div>
                        <input class="flex-grow" type="text" placeholder="Brand Slug" name="slug"
                            id="brandSlug" tabindex="0" value="{{$brand->slug}}" aria-required="true" required="">
                    </fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            @if ($brand->image)
                                <div class="item" id="imgpreview" >
                                    <img src="/uploads/brands/{{$brand->image}}" class="effect8" alt="" id="previewImage">
                                </div>
                            @endif
