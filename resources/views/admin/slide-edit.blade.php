            ...
            <div class="wg-box">
                <form class="form-new-product form-style-1" method="POST" action="{{route('admin.slide.update')}}" enctype="multipart/form-data">
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Tag Line" name="tagline" tabindex="0" value="{{$slide->tagline}}" aria-required="true" required="">
                    </fieldset>
                    ...
                    <fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            @if ($slide->image)
                                <div class="item" id="imgpreview"  class="item" id="imgpreview" >
                                    <img src="/uploads/slides/{{$slide->image}}" class="effect8" alt="" id="previewImage">
