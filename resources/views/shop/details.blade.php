    ...
    <main class="pt-90">
        ...
        <div class="row">
            ...
            <div class="product-single__media" data-media-type="vertical-thumbnail">
                ...
                <div class="swiper-container">
                    ...
                    <div class="swiper-slide product-single__image-item">
                        <img loading="lazy" class="h-auto" src="/uploads/products/{{$product->image}}" width="674"
                        height="674" alt="" />
                        <a data-fancybox="gallery" href="/uploads/products/{{$product->image}}" data-bs-toggle="tooltip"
                    ...
                    <div class="swiper-slide product-single__image-item">
                        <img loading="lazy" class="h-auto" src="/uploads/products/{{$img}}" width="674"
                        height="674" alt="" />
                        <a data-fancybox="gallery" href="/uploads/products/{{$img}}" data-bs-toggle="tooltip"
                        data-bs-placement="left" title="Zoom">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <use href="#icon_zoom" />
                        </svg>
                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto" src="/uploads/products/thumbnails/{{$product->image}}" width="104" height="104" alt="" /></div>
                        @foreach (explode(',',$product->images) as $img)
                            <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto" src="/uploads/products/thumbnails/{{$img}}" width="104" height="104" alt="" /></div>
                        @endforeach
                    </div>
                </div>
                </div>
            ...
            <div class="product-single__addtolinks">
                ...
                <form action="{{route('whishlist.item.remove',['rowId'=>Cart::instance('whishlist')->content()->where('id',$product->id)->first()->rowId])}}" method="POST" id="remove-item-whishlist">
                    @csrf
                    @method('DELETE') 
                    <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist filled-heart" onclick="document.getElementById('remove-item-whishlist').submit()"><svg width="16" height="16" viewBox="0 0 20 20"
                        fill="none" xmlns="http://www.w3.org/2000/svg">
                        <use href="#icon_heart" />
                    </svg><span>Remove from Wishlist</span></a>
                </form>    
                @else
                <form action="{{route('whishlist.add')}}" method="POST" id="whishlist-form">
                    @csrf
                    <input type="hidden" name="id" value="{{$product->id}}">
                    <input type="hidden" name="name" value="{{$product->name}}">
                    <input type="hidden" name="price" value="{{$product->sale_price == ''?$product->regular_price : $product->sale_price}}">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide product-card">
                    <div class="pc__img-wrapper">
                        <a href="{{route('shop.product.detail',['product_slug'=>$related_product->slug])}}">
                        <img loading="lazy" src="/uploads/products/{{ $related_product->image}}" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                        @foreach (explode(',',$related_product->images) as $img)
                            <img loading="lazy" src="/uploads/products/{{ $img}}" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img pc__img-second">
                        @endforeach
                        </a>
