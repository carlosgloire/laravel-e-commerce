                ...
                <div class="section-menu-left" >
                    <div class="box-logo">
                        <a href="{{route("admin.index")}}" id="site-logo-inner">
                            <img style="height:53px" class="logo_icon" id="logo_header" alt="" src="/images/logo/logo.png"
                ...
                <div class="section-content-right">
                        ...
                        <div class="wrap">
                            <div class="header-left">
                                <a href="{{route('admin.index')}}">
                                    <img class="" style="height:60px" id="logo_header_mobile" alt="" src="/images/logo/logo.png"
                                        data-light="/images/logo/logo.png" data-dark="/images/logo/logo.png"
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright  {{date('Y')}} FashionShopKigali</div>
                        </div>
                    </div>
