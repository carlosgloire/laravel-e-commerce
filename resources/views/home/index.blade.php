        ...
        <div class="swiper-slide">
          <div class="overflow-hidden position-relative h-100">
            <div class="slideshow-character position-absolute bottom-0 pos_right-center">
              <img loading="lazy" src="/uploads/slides/{{$slide->image}}" width="542" height="733"
                alt="{{$slide->tagline}}"
            ...
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
              ...
              <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">{{$slide->subtitle}}</p></h2>
              <a href="{{$slide->link}}"
        ...
        <div class="position-relative">
          <div class="swiper-container js-swiper-slider" data-settings='{
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <img loading="lazy" class="w-100 h-auto mb-3" src="/uploads/categories/{{$category->image}}" width="124"
                    ...
                    <div class="swiper-slide product-card product-card_style3">
                      <div class="pc__img-wrapper">
                        <a href="{{route('shop.product.detail',['product_slug'=>$sproduct->slug])}}">
                          <img loading="lazy" src="/uploads/products/{{$sproduct->image}}" width="258" height="313"
                            alt="Cropped Faux leather Jacket" class="pc__img">
                            @foreach (explode(',',$sproduct->images) as $img)
