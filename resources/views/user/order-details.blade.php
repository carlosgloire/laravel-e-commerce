            ...
            <div class="col-lg-10">
                <div class="wg-box">
                    <div class="flex items-center justify-between gap10 flex-wrap">
                            ...
                            <div class="col-6 text-right"><h5>Ordered Details</h5></div>
                            <div class="col-6"> <a class="btn btn-sm btn-danger" href="{{route('user.orders')}}">Back</a></div>
                            ...
                            <tbody>
                                @foreach ($orderItems as $item)
                                    <tr>
                                        <td class="pname" >
                                            <div class="image">
                                                <img src="/uploads/products/{{$item->product->image}}" alt="{{$item->name}}" class="image">
                                            </div>
                                            <div class="name">
      ...
      document.addEventListener('DOMContentLoaded', function() {
          ...
          cancelButtons.forEach(button => {
              button.addEventListener('click', function(e) {
                  ...
                  // Using SweetAlert (assuming swal is available globally)
                  swal({
                      title: "Are you sure to cancel this order?",
                      text: "Once canceled you will not be able to recover it",
                      buttons: ['No', 'Yes'],
